...
func (r *TodoRepository) GetAll(ctx context.Context, userID pgtype.Int8) ([]sqlc.Todo, error) {
	return r.queries.GetTodos(ctx, userID)
}
...
func (r *TodoRepository) GetCompleted(ctx context.Context, userID pgtype.Int8) ([]sqlc.Todo, error) {
	return r.queries.GetCompletedTodos(ctx, userID)
}

func (r *TodoRepository) GetPending(ctx context.Context, userID pgtype.Int8) ([]sqlc.Todo, error) {
	return r.queries.GetPendingTodos(ctx, userID)
}
...
func (r *TodoRepository) Search(ctx context.Context, arg sqlc.SearchTodosParams) ([]sqlc.Todo, error) {
	return r.queries.SearchTodos(ctx, arg)
}
